...
conn.connect()
const leo = conn.leo
/* 𝕱𝖚𝖓𝖈𝖎𝖔𝖓𝖊𝖘 |Jack_paymon | JackiBot*/
//𝕽𝖊𝖌𝖎𝖘𝖙𝖗𝖔
...
Recuerda siempre seguir las reglas y mantener una formalidad respetuosa`
    ...
    {"title": 'Sigueme En Youtube te regalo un chicle',       
    "body": 'Te regalo un chicle',  
    "thumbnail": fs.readFileSync('./media/imagen/youtube-mi.jpg'),
    "sourceUrl": 'https://youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w'}}})
...
*Felicitaciones eres uno de los administradores.*`
   let buff = await getBuffer(ppimg)
    ...
    {"title": 'Suscribete a mi canal de Youtube',       
    "body": 'Te regalo un chicle',  
    "thumbnail": fs.readFileSync('./media/imagen/youtube-mi.jpg'),
    "sourceUrl": 'https://youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w'}}})
...
const command = comm
  ...
  const ownerNumber = "61411110947@s.whatsapp.net"
  const Oowner  = "61411110947@s.whatsapp.net"
  const the34 = "18295176783@s.whatsapp.net"
...
let authorname = leo.contacts[from] != undefined ? leo.contacts[from].vname || leo.contacts[from].notify : undefined	
...
╰━─━─☾︎🌊☽︎─━─━╯`
const cmenu = `
Buenas  _@${sender.split('@')[0]}_
_*<MENÚ SIMPLE + />*_

||- *_-DATOS DEL USUARIO-_*
° 式 ⃟🐈‍⬛ Usuario: _@${sender.split('@')[0]}_
° 式 ⃟🐈‍⬛ XP: _${getLevelingXp(sender)}_
° 式 ⃟🐈‍⬛ Nivel: _${getLevel1}_

||- *_-INFO DEL GRUPO-_*
° 式 ⃟🐈‍⬛ Nombre: _${groupMetadata.subject}_
° 式 ⃟🐈‍⬛ Administradores: _${groupAdmins.length}_
° 式 ⃟🐈‍⬛ Miembros: _${groupMembers.length - groupAdmins.length }_
° 式 ⃟🐈‍⬛ Total de Participantes: _${groupMembers.length}_

||- *_-INFO DEL BOT-_*
° 式 ⃟🐈‍⬛ Creador: @${Oowner.split('@')[0]}
° 式 ⃟🐈‍⬛ Hora: ${jm}
° 式 ⃟🐈‍⬛ Dispositivo: _${leo.user.phone.device_manufacturer}_
° 式 ⃟🐈‍⬛ Servidor: ${leo.browserDescription[0]}
° 式 ⃟🐈‍⬛ Version de WhatsApp: ${leo.browserDescription[2]}
° 式 ⃟🐈‍⬛ Navedador: ${leo.browserDescription[1]}
° 式 ⃟🐈‍⬛ Velocidad: ${process.uptime()} 
° 式 ⃟🐈‍⬛ Chat Totales: ${totalchat.length}`

const extra = `
𝐂𝐨𝐦𝐚𝐧𝐝𝐨𝐬 𝐝𝐞 𝐨𝐰𝐧𝐞𝐫 𝐨 𝐁𝐨𝐭

||- *_-Banear Usuario del Bot-_*

° 式 ⃟🐈‍⬛ ${prefix}autoadmin
° 式 ⃟🐈‍⬛ ${prefix}autodemote
° 式 ⃟🐈‍⬛ ${prefix}autokick
...
const nivel = `
° 式 ⃟👤 *Nombre* : ${pushname}
° 式 ⃟☎️️ *Número* : @${sender.split("@")[0]}
° 式 ⃟🌐 *Link* : wa.me/${sender}
° 式 ⃟🎖️*Rango* : ${rango}
*Info* : __
` 
const texto = `
...
・丕🍓꙳︎ Hola Bienvenido a JᴀᴄᴋɪBᴏᴛ・

° 式 ⃟👨‍💻 _*Creador :* @⁨JᴀᴄᴋSɪᴛᴏ-⃫⃟に公式⁩_
° 式 ⃟🔣 _*Prefix :* Multi Prefix_
...
_𝑺𝒊 𝒆𝒍 𝒃𝒐𝒕 𝒑𝒓𝒆𝒔𝒆𝒏𝒕𝒂 𝑭𝒂𝒍𝒍𝒐𝒔 𝒓𝒆𝒑𝒐𝒓𝒕𝒂𝒓 𝒂 @${Oowner.split('@')[0]}_
...
_*<OPCIONES DE OWNER+ />*_

° 式 ⃟🌹 ${prefix}ban

_*<DESBANEAR USUARIOS DEL BOT+ />*_

° 式 ⃟🌹 ${prefix}unban
° 式 ⃟🌹 ${prefix}desban

_*<CAMBIAR MODO SELF / PRIVADO+ />*_

° 式 ⃟🌹 ${prefix}privado
° 式 ⃟🌹 ${prefix}self

_*<CAMBIAR MODO PÚBLICO+ />*_

° 式 ⃟🛡️ ${prefix}publico


_*<VACIAR GRUPOS COMPLETOS+ />*_
Usᴀʀ Bᴀᴊᴏ ᴛᴜs ᴘʀᴏᴘɪᴀ ʀᴇsᴘᴏɴsᴀʙɪʟɪᴅᴀᴅ
(Sᴏʟᴏ ᴏᴡɴᴇʀ ᴘᴜᴇᴅᴇ)

° 式 ⃟🥷${prefix}fullkick

_*<DAR ADMIN A TODO EL GRUPO+ />*
° 式 ⃟💟 ${prefix}promoteall

_*<QUITAR ADMIN A TODO EL GRUPO />*
...
° 式 ⃟🍩 ${prefix}hidetag
° 式 ⃟🍩 ${prefix}tagall
° 式 ⃟🍩 ${prefix}imagetang
° 式 ⃟🍩 ${prefix}stickertang
...
° 式 ⃟🫂 ${prefix}welcome on
° 式 ⃟🫂 ${prefix}bv on 
° 式 ⃟🫂 ${prefix}bienvenida on 
° 式 ⃟🫂 ${prefix}welcome off
° 式 ⃟🫂 ${prefix}bv off
° 式 ⃟🫂 ${prefix}bienvenida off 

_*<PROTECCIÓN + />*_

° 式 ⃟🛡️ ${prefix}grupo open
° 式 ⃟🛡️ ${prefix}grupo close
° 式 ⃟🛡️ ${prefix}antigp on /off 
° 式 ⃟🛡️ ${prefix}antilink on / off
° 式 ⃟🛡️ ${prefix}antimedia on / off
° 式 ⃟🛡️ ${prefix}antisticker on / off
° 式 ⃟🛡️ ${prefix}antileg on/off 

_*<PUBLIC + />*_

_*<ACCIÓNES DE USUARIO + />*_

° 式 ⃟🛡️ ${prefix}autokick
° 式 ⃟🛡️ ${prefix}autoadmin

_*<QUIEN HA VISTO ESTE MENSAJE + />*_

° 式 ⃟🛡️ ${prefix}sider (+mensaje del bot)

_*<LISTA DE USUARIOS EN LINEA + />*_

° 式 ⃟🛡️ ${prefix}listonine
° 式 ⃟🛡️ ${prefix}listaenlinea
° 式 ⃟🛡️ ${prefix}enlinea
° 式 ⃟🛡️ ${prefix}onlie
`

const multimedia = `_*<MULTIMEDIA + />*_

_*<MULTIMEDIA + />*_

° 式 ⃟📟${prefix}imagen (+ imagen)
° 式 ⃟📟${prefix}wp


_*<BUSQUEDA DE GOOGLE + />*_

式 ⃟🌍 ${prefix}google (+ palabra)
...
_*<EFECTOS PARA VÍDEOS + />*_

° 式 ⃟📹 ${prefix}sinsonido
° 式 ⃟📹 ${prefix}vefecto
° 式 ⃟📹 ${prefix}mirror 
° 式 ⃟📹 ${prefix}vlento
° 式 ⃟📹 ${prefix}vrapido
...
_*<DESCARGÁR MUSICA + />*_

式 ⃟🎧 ${prefix}ytmp3
式 ⃟🎧 ${prefix}play

_*<EFECTOS PARA AUDIOS + />*_

° 式 ⃟🎙️ ${prefix}bass
° 式 ⃟🎙️ ${prefix}trigger
° 式 ⃟🎙️ ${prefix}lento 
° 式 ⃟🎙️ ${prefix}rapido
° 式 ⃟🎙️ ${prefix}ardilla
° 式 ⃟🎙️ ${prefix}imut
° 式 ⃟🎙️ ${prefix}hode
° 式 ⃟🎙️ ${prefix}grave 
° 式 ⃟🎙️ ${prefix}fantasma
`
...
*Youtube:* youtube.com/c/Jacksito98`
...
`
const install = 
`*INTAGRAM DE LOS ADMINS*

🍒 𝐈𝐆 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎. 🍒
instagram.com/____etheral

𝐊𝐮𝐢𝐧. 
Instagram.com/w6y.x9v
JᴀᴄᴋSɪᴛᴏ|他妈的
...
if (choute.message.buttonsResponseMessage){
  ...
  if (test.includes(`sex`)){
    ...
    {"title": `Hola ${pushname} 👋🏻`, 
    "body": `SIGUEME EN YOUTUBE`, "mediaType": 2, 
    "thumbnail": fs.readFileSync(`media/imagen/youtube-min.jpg`), 
    mediaUrl: "https://www.youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w"}}}) 
    addFilter(from)
...
if (choute.message.listResponseMessage){
  ...
  leo.updatePresence(from, Presence.composing)
  if (!isRegister) return reply(baby.only.usrReg)
tampa = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999, "message": `${reglas}`, "footerText": "*JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的*", "thumbnail": fs.readFileSync('./media/imagen/imgregla.jpg'), "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [sender,Oowner]}, quoted:choute, })
...
if (choute.message.listResponseMessage){
  ...
  `${texto}\n${allmenu}`
    ...
    buttonsMessage = {
    contentText: `${txtt}`,
    footerText: '© Creator Jacksito98', imageMessage: imageMsg,
    buttons: buttons1,
    headerType: 4}
...
`${agra}`
  ...
  buttonsMessage = {
  contentText: `${txtt}`,
  footerText: '© Creator JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的', imageMessage: imageMsg,
  buttons: buttons1,
  headerType: 4}
...
case 'menu':
               ...
               txtt =`${cmenu}`              
                ...
                {buttonId:`sex`,buttonText:{displayText:'Redes sociales🍒'},type:1},
                {buttonId:`grupo`,buttonText:{displayText:'Grupo OFC📍'},type:1}],
                {contextInfo: { mentionedJid: [sender,Oowner]}})
...
.on('end', function () {
console.log('Finish')
exec(`webpmux -set exif ${addMetadata('leo-BOT', 'Felixcrack')} ${ran} -o ${ran}`, async (error) => {
if (error) return 
leo.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: choute})
fs.unlinkSync(media)	
fs.unlinkSync(ran)	
 })
 })
...
exec(`webpmux -set exif ${addMetadata('leo-BOT', 'Felixcrack')} ${ranw} -o ${ranw}`, async (error) => {
if (error) return reply(ind.stick())
leo.sendMessage(from, fs.readFileSync(ranw), sticker, {quoted: choute})
fs.unlinkSync(ranw)
})
})
})
...
case 'tovid':
    ...
    if (!isRegister) return reply(baby.only.usrReg)
            ...
            owgi = await leo.downloadAndSaveMediaMessage(ger)
...
🌐 *Youtube:* youtube.com/c/thechout\nCualquier apoyo me serviria de mucho`, contextInfo: { mentionedJid: [Oowner, sender], "forwardingScore": 508, "isForwarded": true, "externalAdReply": 
    ...
    "sourceUrl": 'https://www.youtube.com/channel/UCTfpv-KmckjC1rwPKqw_t1w'}}})
    break          
...
case 'slot':
		case 'casino':
            ...
            leo.sendMessage(from, `[  🎰 | CASINO ]\n-----------------\n🍋 : 🍌 : 🍍\n${somtoy}<=====\n🍋 : 🍌 : 🍍\n\n\nDescripción: Si obtienes 3 iguales significa que ganas\n\nEjemplo : 🍌 : 🍌 : 🍌<=====`, MessageType.text, { quoted: choute })
            break
...
leo.sendMessage(from, attp2, sticker, {quoted: choute})
break
...
if (!isRegister) return reply(baby.only.usrReg)
                ...
                if (!botAdmin) return reply(baby.only.Badmin)
if ((isMedia && !choute.message.videoMessage || isQuotedSticker) && args.length == 0) {
encmediau = isQuotedSticker ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
...
leo.sendMessage(from, ini_buffer, sticker, options)
fs.unlinkSync(file)
} else if ((isMedia && !choute.message.videoMessage || isQuotedImage) && args.length == 0) {
encmediau = isQuotedImage ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await leo.groupMetadata(from)
var member = group['participants']
...
ini_buffer = fs.readFileSync(file)
leo.sendMessage(from, ini_buffer, image, options)
fs.unlinkSync(file)
} else if ((isMedia && !choute.message.videoMessage || isQuotedAudio) && args.length == 0) {
encmediau = isQuotedAudio ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await leo.groupMetadata(from)
var member = group['participants']
...
ini_buffer = fs.readFileSync(file)
leo.sendMessage(from, ini_buffer, audio, options)
fs.unlinkSync(file)
 } else if ((isMedia && !choute.message.videoMessage || isQuotedVideo) && args.length == 0) {
encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await leo.groupMetadata(from)
var member = group['participants']
...
ini_buffer = fs.readFileSync(file)
leo.sendMessage(from, ini_buffer, video, options)
fs.unlinkSync(file)
} else if ((isMedia && !choute.message.videoMessage || isQuotedDocument) && args.length == 0) {
encmediau = isQuotedDocument ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
value = args.join(" ")
var group = await leo.groupMetadata(from)
var member = group['participants']
...
ini_buffer = fs.readFileSync(file)
leo.sendMessage(from, ini_buffer, document, options)
fs.unlinkSync(file)
}  else if ((isMedia && !choute.message.videoMessage || isQuotedVideo) && args.length == 0) {
encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(choute).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : choute
file = await leo.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
...
sendFileFromUrl(logo, image, {quoted: choute, caption: '*🔥 𝐋??𝐠𝐨𝐬 𝐁𝐲 JᴀᴄᴋSɪᴛᴏ-⃫⃟冰⁩他妈的 🔥*\n*CANAL DEL CREADOR:*\nhttps://www.youtube.com/channel/UC-HPutaDGeTPjrCId0bXQgg?sub_confirmation=1', sendEphemeral: true})
break	
...
case 'ban':
                ...
                buttons: buttons1,
                headerType: 4}} 
                else if (isQuotedMsg) {if (quotedMsg.sender.match('61411110947')) return reply(`🤨`)
...
leo.sendMessage('61411110947@s.whatsapp.net', options, text, {quoted: choute})
